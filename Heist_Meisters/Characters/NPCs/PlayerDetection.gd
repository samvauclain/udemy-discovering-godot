...
const MAX_DETECTION_RANGE = 480

var Player

func _ready():
	# set Player to be only node with the name Player starting search from root, if there's any other node named Player this will not work.
